...
#def candplot(st, imgall, data_dm):
def candplot(st, imgall, data_dm, loclabel, snrs=[], outname=''):
    """ Takes results of imaging threshold operation and data to make candidate plots.
